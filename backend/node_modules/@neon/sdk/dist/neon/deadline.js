...
function resolveTimeoutMs(value) {
	...
	if (typeof value !== "number" || Number.isNaN(value) || value <= 0) throw new NeonClientError(`requestTimeoutMs must be a positive number of milliseconds, or Infinity to disable; received ${String(value)}.`);
	if (value > MAX_TIMER_MS) throw new NeonClientError(`requestTimeoutMs must be at most ${MAX_TIMER_MS}ms (about 24.8 days); received ${value}. Pass Infinity for no deadline.`);
	return value;
}
/**

...
import { ResolvedConfig } from "./context.js";

//#region src/neon/config.d.ts
/** Options accepted by {@link createNeonClient}. */
interface NeonConfig<Throw extends boolean = false> {
  /**
...
declare function resolveConfig(config: NeonConfig<boolean>): ResolvedConfig;
//#endregion
export { NeonConfig, resolveConfig };

...
var RequestContext = class {
	...
	*/
	...
	resolveWait(opts, methodDefault) {
		return opts?.waitForReadiness ?? this.#config.waitForReadiness ?? methodDefault;
	}
	...
	async run(opts, exec, map) {
		return finalize(await this.execute(opts, exec, map), this.shouldThrow(opts));
	}
